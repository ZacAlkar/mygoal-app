    ...
    return (
        <>
            <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                    <img className="mx-auto h-48 w-auto" src={logo} alt="MyGoal"/>
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form className="space-y-6" action="#" method="POST">
                        ...
                        <div>
                            ...
                            <div className="mt-2">
                                <input id="password" name="password" type="password" autoComplete="current-password" required className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-silver-teal placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-tahiti sm:text-sm sm:leading-6"/>
                            </div>
                        </div>
